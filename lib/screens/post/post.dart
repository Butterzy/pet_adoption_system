...
import 'package:pet_adoption_system/screens/post/register_post.dart';
...
class Post extends StatefulWidget {
  PetData petData;
  Post({Key? key, required this.petData}) : super(key: key);
...
Positioned(
                   ...
                   left:140,
                    child: Container(
                        height: 530,
                        width: 530,
                        child: Image.asset('assets/images/readycat.png'))),
                      Positioned(
                          bottom: 0.0,
                          child: Container(
  ...
  Widget getCustomContainer() {
    switch (selectedPostSwitch) {
      case PostSwitch.upcoming:
        return PostList(pet_ID: widget.petData.pet_ID!, isExpired: false);
      case PostSwitch.expired:
        return PostList(pet_ID: widget.petData.pet_ID!, isExpired: true);
    }
  }
}
