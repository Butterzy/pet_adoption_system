...
class DeletePostTile extends StatefulWidget {
  ...
  @override
  State<DeletePostTile> createState() => _DeletePostTileState();
}

class _DeletePostTileState extends State<DeletePostTile> {
